...
本リポジトリでは、第1論文を Chronicle Theory 論文シリーズ全体への入口として位置づけます。役割は、AIアラインメントに含まれる価値固定の隠れた形而上学を明らかにし、Chronicleの問いを開くことです。

現時点でのシリーズ境界は以下です。

```text
第1論文：なぜアラインメントの問いだけでは不十分なのか。
第2論文：安全性には何が必要か。
第6論文：知性とは何か。
```

第2論文では、AI安全性の再定位として相互作用の継続性を展開します。後続のChronicle Theory本体論文では、Chronicle Theoryを知性一般の理論として定式化します。
