...
Control is not inherently illegitimate. Complex technologies require constraints. However, AI differs from many prior technologies because it increasingly mediates language, judgment, knowledge access, decision support, education, creativity, and social interaction. Control over AI behavior can therefore become indirect control over the conditions of meaning-making.
